window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:src/client/SplitContainer.module.css.mjs
		const css$2 = ".XkLICG_host{flex:1;min-width:0;min-height:0;display:flex}.XkLICG_split{flex:1;min-width:0;min-height:0;display:grid}.XkLICG_paneSide{min-width:0;min-height:0;display:flex}.XkLICG_paneSide>*{flex:1;min-width:0;min-height:0}.XkLICG_divider{z-index:1;touch-action:none;cursor:col-resize;background:0 0;outline:none;position:relative}.XkLICG_split[data-direction=vertical] .XkLICG_divider{cursor:row-resize}.XkLICG_divider:focus-visible{outline:2px solid var(--dsw-static-deepseek-500);outline-offset:-1px;border-radius:2px}";
		...
		var SplitContainer_module_css_default = {
			"divider": "XkLICG_divider",
			"host": "XkLICG_host",
			"paneSide": "XkLICG_paneSide",
			"split": "XkLICG_split"
		};
		//#endregion
		...
		*/
		...
		function IconSplitHorizontal16({ className }) {
		...
		function IconSplitVertical16({ className }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				className,
				width: "16",
				height: "16",
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
					fillRule: "evenodd",
					clipRule: "evenodd",
					d: `${PANEL_FRAME}M1.8831 7.31989H14.11693V8.68012H1.8831V7.31989Z`,
					fill: "currentColor"
				})
			});
		}
		/** Expand-to-viewport: ui-sidebar-right's FullscreenGlyph. */
		function IconFullscreen16({ className }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				className,
				width: "16",
				height: "16",
		...
		function IconFullscreenExit16({ className }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("g", {
					...
					strokeWidth: "0.105646",
					strokeLinecap: "square",
					children: ["M10.698 0.379607H9.43015L9.37698 0.378916L9.37767 0.432087V1.066L9.37698 4.0277C9.37698 4.40856 9.37653 4.74998 9.40667 5.02828C9.43826 5.31934 9.51053 5.62311 9.71051 5.89835C9.81779 6.04587 9.94762 6.1757 10.0951 6.28298C10.3704 6.48296 10.6741 6.55523 10.9652 6.58682C11.2435 6.61696 11.5849 6.61651 11.9658 6.61651L14.9275 6.61582H15.5614L15.6146 6.61651L15.6139 6.56334V5.29552L15.6146 5.24235L15.5614 5.24304H14.9275L11.9658 5.24235C11.5545 5.24235 11.3009 5.24191 11.1137 5.22163C10.9443 5.20329 10.9078 5.17501 10.9038 5.17191C10.8724 5.14911 10.8444 5.12112 10.8216 5.08974C10.8185 5.08566 10.7902 5.04908 10.7719 4.87982C10.7516 4.69263 10.7511 4.439 10.7511 4.0277L10.7505 1.066V0.432087L10.7511 0.378916L10.698 0.379607Z", "M5.29031 15.6167L6.55813 15.6167L6.6113 15.6174L6.61061 15.5642L6.61061 14.9303L6.6113 11.9686C6.6113 11.5878 6.61176 11.2463 6.58161 10.968C6.55003 10.677 6.47775 10.3732 6.27777 10.098C6.17049 9.95045 6.04067 9.82062 5.89315 9.71334C5.6179 9.51336 5.31413 9.44109 5.02307 9.40951C4.74478 9.37936 4.40335 9.37981 4.02249 9.37981L1.06079 9.3805L0.426879 9.3805L0.373708 9.37981L0.374398 9.43298L0.374398 10.7008L0.373708 10.754L0.426879 10.7533L1.06079 10.7533L4.02249 10.754C4.43379 10.754 4.68742 10.7544 4.87461 10.7747C5.04393 10.793 5.08047 10.8213 5.08453 10.8244C5.11591 10.8472 5.1439 10.8752 5.1667 10.9066C5.16982 10.9107 5.19808 10.9472 5.21642 11.1165C5.2367 11.3037 5.23714 11.5573 5.23714 11.9686L5.23783 14.9303L5.23783 15.5642L5.23714 15.6174L5.29031 15.6167Z"].map((d) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d }, d))
				})
			});
		}
		//#endregion
		//#region \0dsh-css:src/client/PaneDropOverlay.module.css.mjs
		const css$1 = ".H5V95q_layer{z-index:30;pointer-events:none;position:absolute;inset:0}.H5V95q_center,.H5V95q_left,.H5V95q_right,.H5V95q_top,.H5V95q_bottom{border:1px solid var(--dsw-static-deepseek-500);background:color-mix(in srgb, var(--dsw-static-deepseek-500) 12%, transparent);border-radius:10px;position:absolute}.H5V95q_center{inset:20%}.H5V95q_left{left:var(--drop-pad,0px);right:calc(50% + 3px);top:var(--drop-pad,0px);bottom:var(--drop-pad,0px)}.H5V95q_right{left:calc(50% + 3px);right:var(--drop-pad,0px);top:var(--drop-pad,0px);bottom:var(--drop-pad,0px)}.H5V95q_top{left:var(--drop-pad,0px);right:var(--drop-pad,0px);top:var(--drop-pad,0px);bottom:calc(50% + 3px)}.H5V95q_bottom{left:var(--drop-pad,0px);right:var(--drop-pad,0px);top:calc(50% + 3px);bottom:var(--drop-pad,0px)}.H5V95q_center,.H5V95q_left,.H5V95q_right,.H5V95q_top,.H5V95q_bottom{transition:left .15s ease-out,right .15s ease-out,top .15s ease-out,bottom .15s ease-out}";
		...
		var PaneDropOverlay_module_css_default = {
			"bottom": "H5V95q_bottom",
			"center": "H5V95q_center",
			"layer": "H5V95q_layer",
			"left": "H5V95q_left",
			"right": "H5V95q_right",
			"top": "H5V95q_top"
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:src/client/PaneWorkspace.module.css.mjs
		const css = "._0n3KuW_host{flex:1;min-width:0;min-height:0;padding:8px;display:flex}._0n3KuW_singleSurface{--drop-pad:8px;flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}._0n3KuW_pane{background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}._0n3KuW_pane>*{flex:1;min-width:0;min-height:0}._0n3KuW_pane[data-focused]{border-color:var(--dsw-static-deepseek-500)}._0n3KuW_fullscreenHost{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}._0n3KuW_pane._0n3KuW_paneFullscreen{background:0 0;border-color:#0000;border-radius:0}._0n3KuW_heroHeader{flex:none;justify-content:space-between;align-items:center;gap:16px;min-height:30px;padding:10px 20px 0;display:flex}._0n3KuW_heroTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1;padding:4px 8px;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}._0n3KuW_heroActions{flex:none;align-items:center;gap:2px;display:flex}._0n3KuW_splitButton,._0n3KuW_closeButton,._0n3KuW_heroButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;padding:6px;display:flex}._0n3KuW_splitButton:hover,._0n3KuW_splitButton:focus-visible,._0n3KuW_closeButton:hover,._0n3KuW_closeButton:focus-visible,._0n3KuW_heroButton:hover,._0n3KuW_heroButton:focus-visible{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var PaneWorkspace_module_css_default = {
			"closeButton": "_0n3KuW_closeButton",
			"fullscreenHost": "_0n3KuW_fullscreenHost",
			"heroActions": "_0n3KuW_heroActions",
			"heroButton": "_0n3KuW_heroButton",
			"heroHeader": "_0n3KuW_heroHeader",
			"heroTitle": "_0n3KuW_heroTitle",
			"host": "_0n3KuW_host",
			"pane": "_0n3KuW_pane",
			"paneFullscreen": "_0n3KuW_paneFullscreen",
			"singleSurface": "_0n3KuW_singleSurface",
			"splitButton": "_0n3KuW_splitButton"
		};
		//#endregion
