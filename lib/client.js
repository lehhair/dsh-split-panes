window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$2 = ".ytwmKG_host{flex:1;min-width:0;min-height:0;display:flex}.ytwmKG_split{flex:1;min-width:0;min-height:0;display:grid}.ytwmKG_paneSide{min-width:0;min-height:0;display:flex}.ytwmKG_paneSide>*{flex:1;min-width:0;min-height:0}.ytwmKG_divider{z-index:1;touch-action:none;cursor:col-resize;background:0 0;outline:none;position:relative}.ytwmKG_split[data-direction=vertical] .ytwmKG_divider{cursor:row-resize}.ytwmKG_divider:focus-visible{outline:2px solid var(--dsw-static-deepseek-500);outline-offset:-1px;border-radius:2px}";
		...
		*/
		...
		const css = ".wYQfYq_host{flex:1;min-width:0;min-height:0;padding:8px;display:flex}.wYQfYq_singleSurface{--drop-pad:8px;flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}.wYQfYq_pane{background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}.wYQfYq_pane>*{flex:1;min-width:0;min-height:0}.wYQfYq_pane[data-focused]{border-color:var(--dsw-static-deepseek-500)}.wYQfYq_fullscreenHost{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}.wYQfYq_pane.wYQfYq_paneFullscreen{background:0 0;border-color:#0000;border-radius:0}.wYQfYq_heroHeader{min-height:32px;padding:var(--pane-pad-top,12px) 20px 0;flex:none;justify-content:space-between;align-items:center;gap:16px;display:flex}.wYQfYq_heroTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:16px;overflow:hidden}.wYQfYq_heroActions{flex:none;align-items:center;gap:2px;display:flex}.wYQfYq_pane{--pane-pad-top:3px}.wYQfYq_splitButton,.wYQfYq_closeButton,.wYQfYq_heroButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;padding:6px;display:flex}.wYQfYq_splitButton:hover,.wYQfYq_splitButton:focus-visible,.wYQfYq_closeButton:hover,.wYQfYq_closeButton:focus-visible,.wYQfYq_heroButton:hover,.wYQfYq_heroButton:focus-visible{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}";
