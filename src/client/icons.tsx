/**
 * Local pane-chrome icons — the same glyphs, same size as the official
 * right-side-bar chrome (ui-sidebar-right's FullscreenGlyph /
 * ExitFullscreenGlyph and ui-dockkit's SplitGlyph), inlined verbatim so the
 * split panes never read as a different visual language. currentColor; no
...
export function IconSplitHorizontal16(props: IconProps) {
  return (
    <svg {...props} width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
